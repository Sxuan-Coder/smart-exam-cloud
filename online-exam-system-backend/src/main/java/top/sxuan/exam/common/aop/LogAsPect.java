package top.sxuan.exam.common.aop;
...
public class LogAsPect {
    ...
    /**
     * 定义切入点，匹配 top.sxuan.exam.controller 包及其子包下所有以 Controller 结尾的类的所有公共方法
     * 即当这些方法被调用时，会触发对应的通知
     */
    @Pointcut("execution(public * top.sxuan.exam.controller..*Controller.*(..))")
