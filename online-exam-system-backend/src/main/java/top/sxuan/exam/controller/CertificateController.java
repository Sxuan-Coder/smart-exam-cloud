...
import top.sxuan.exam.common.group.CertificateGroup;
...
public class CertificateController {
    ...
    public Result<String> addCertificate(
            @RequestBody @Validated(CertificateGroup.CertificateInsertGroup.class) CertificateForm certificateForm) {
    ...
    public Result<IPage<Certificate>> pagingCertificate(
    ...
    public Result<IPage<MyCertificateVO>> getMyCertificate(
            @RequestParam(value = "pageNum", required = false, defaultValue = "1") Integer pageNum,
            @RequestParam(value = "pageSize", required = false, defaultValue = "10") Integer pageSize,
