package top.sxuan.exam.task;

import top.sxuan.exam.common.result.Result;
import top.sxuan.exam.mapper.*;
import top.sxuan.exam.model.entity.*;
import top.sxuan.exam.model.enums.ExamState;
import top.sxuan.exam.model.vo.exam.ExamQuDetailVO;
...
public class ExamTask {
    ...
    public Result<ExamQuDetailVO> handExam(UserExamsScore ues) {
        ...
        // 检查是否在Integer范围内
        // if (secondsDifference <= Integer.MAX_VALUE && secondsDifference >=
        // Integer.MIN_VALUE)
