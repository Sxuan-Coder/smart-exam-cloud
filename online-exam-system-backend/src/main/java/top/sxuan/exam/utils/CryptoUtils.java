...
import top.sxuan.exam.utils.CryptoUtils.Algorithm.Encryption;
import top.sxuan.exam.utils.CryptoUtils.Algorithm.Signing;
...
public class CryptoUtils {
     ...
     * @throws Exception
     */
    public static boolean verifyBySHA256WithRSA(String publicKeyText, String msg, String signatureText)
            throws Exception {
     ...
     * @throws Exception
     */
    public static String encryptSymmetrically(String secretKey, String iv, String plainText, Algorithm algorithm)
            throws Exception {
     ...
     * @throws Exception
     */
    public static String decryptSymmetrically(String secretKey, String iv, String ciphertext, Algorithm algorithm)
            throws Exception {
        SecretKey key = decodeSymmetricKey(secretKey, algorithm);
        IvParameterSpec ivParameterSpec = StringUtils.isBlank(iv) ? null : decodeIv(iv);
     ...
     * @throws Exception
     */
    public static String encryptAsymmetrically(String publicKeyText, String plainText, Algorithm algorithm)
            throws Exception {
     ...
     * @throws Exception
     */
    public static boolean doVerify(String publicKeyText, String msg, String signatureText,
    ...
    private static byte[] transform(Algorithm algorithm, int mode, Key key, IvParameterSpec iv, byte[] msg)
            throws Exception {
     ...
     * <a href=
     * "https://docs.oracle.com/javase/8/docs/technotes/guides/security/StandardNames.html#impl">jdk8中的标准算法</a>
     */
