...
import top.sxuan.exam.converter.ReplyConverter;
...
import top.sxuan.exam.service.IReplyService;
...
public class ReplyServiceImpl extends ServiceImpl<ReplyMapper, Reply> implements IReplyService {
    ...
    public Integer deleteReply(Integer id) {
        ...
        // // 删除子回复
        // LambdaUpdateWrapper<Reply> wrapper = new
        // LambdaUpdateWrapper<Reply>().eq(Reply::getParentId, id);
