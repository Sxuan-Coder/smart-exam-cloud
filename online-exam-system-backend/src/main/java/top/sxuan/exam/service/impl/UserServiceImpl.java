...
import top.sxuan.exam.mapper.GradeMapper;
...
import top.sxuan.exam.service.IUserService;
import top.sxuan.exam.utils.DateTimeUtil;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public Result<String> deleteBatchByIds(String ids) {
        List<Integer> userIds = Arrays.stream(ids.split(",")).map(Integer::parseInt)
