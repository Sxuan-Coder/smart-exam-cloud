...
import top.sxuan.exam.converter.DiscussionConverter;
import top.sxuan.exam.mapper.DiscussionMapper;
import top.sxuan.exam.mapper.ReplyMapper;
import top.sxuan.exam.model.entity.Discussion;
import top.sxuan.exam.model.form.discussion.DiscussionForm;
import top.sxuan.exam.model.vo.discussion.DiscussionDetailVo;
import top.sxuan.exam.model.vo.discussion.PageDiscussionVo;
import top.sxuan.exam.service.IDiscussionService;
...
public class DiscussionServiceImpl extends ServiceImpl<DiscussionMapper, Discussion> implements IDiscussionService {
    ...
    @Override
    public Page<PageDiscussionVo> getOwnerDiscussions(String title, Integer gradeId, Integer currentPage,
            Integer size) {
