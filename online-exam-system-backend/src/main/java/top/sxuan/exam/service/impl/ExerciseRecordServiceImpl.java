...
import top.sxuan.exam.converter.ExerciseConverter;
import top.sxuan.exam.converter.RecordConverter;
...
public class ExerciseRecordServiceImpl extends ServiceImpl<ExerciseRecordMapper, ExerciseRecord>
    ...
    public Result<AnswerInfoVO> getAnswerInfo(Integer repoId, Integer quId) {
        ...
        return exerciseRecord.getIsRight() == 1 ? Result.success("回答正确", answerInfoVO)
                : Result.success("回答错误", answerInfoVO);
