...
public interface CertificateMapper extends BaseMapper<Certificate> {
     ...
     * @return 分页结果
     */
    Page<MyCertificateVO> selectMyCertificate(Page<MyCertificateVO> myCertificateVOPage, Integer pageNum,
            Integer pageSize, Integer userId, String examName);
     ...
     * @return 证书相关Page对象
     */
    IPage<Certificate> selectCertificatePage(IPage<Certificate> page, Integer userId, String certificateName,
