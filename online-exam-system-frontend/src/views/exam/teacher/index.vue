  ...
  <div class="app-container">
    <el-form :inline="true" :model="formInline" class="demo-form-inline">
      ...
      <el-form-item>
        ...
        <el-button type="success" icon="el-icon-cpu" @click="aiComposeVisible = true">AI组卷</el-button>
      </el-form-item>
    </el-form>

    <!-- AI组卷对话框 -->
    <ai-compose-dialog :visible.sync="aiComposeVisible" @success="getExamPage(pageNum, pageSize)" />
...
import AiComposeDialog from '../components/AiComposeDialog'
export default {
  components: { AiComposeDialog },
  data() {
    return {
      aiComposeVisible: false,
      pageNum: 1,
      pageSize: 10,
      data: {
      },
