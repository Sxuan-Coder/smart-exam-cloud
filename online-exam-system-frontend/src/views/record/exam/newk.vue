                    ...
                    <el-col :span="20" style="text-align: left">
                      ...
                      <div class="qu_analysis">
                        <el-card>
                          ...
                          <!-- AI 详细反馈 -->
                          <div v-if="index.aiGradingDetail" style="margin-top: 15px">
                            <el-collapse>
                              <el-collapse-item name="ai">
                                <template slot="title">
                                  <i class="el-icon-cpu" style="margin-right: 8px; color: #409EFF"></i>
                                  <span style="font-weight: bold; color: #409EFF">AI 智能评分深度反馈</span>
                                  <el-tag size="mini" type="primary" effect="plain" style="margin-left: 10px">得分: {{ index.aiScore }}分</el-tag>
                                </template>
                                <div class="ai-feedback-content">
                                  <div v-if="parseAiDetail(index.aiGradingDetail).dimensions" class="ai-dims">
                                    <div v-for="dim in parseAiDetail(index.aiGradingDetail).dimensions" :key="dim.name" class="dim-row">
                                  ...
                                  <div v-if="parseAiDetail(index.aiGradingDetail).deductionDetails" class="ai-deductions">
                                    <div class="section-title">扣分明细：</div>
                                    <ul>
                                      <li v-for="(dec, di) in parseAiDetail(index.aiGradingDetail).deductionDetails" :key="di">{{ dec }}</li>
                                    </ul>
                                  </div>
                                  <div v-if="parseAiDetail(index.aiGradingDetail).improvementSuggestions" class="ai-improve">
                                    <div class="section-title">改进建议：</div>
                                    <p class="improve-text">{{ parseAiDetail(index.aiGradingDetail).improvementSuggestions }}</p>
                                  </div>
                                </div>
                              </el-collapse-item>
                            </el-collapse>
